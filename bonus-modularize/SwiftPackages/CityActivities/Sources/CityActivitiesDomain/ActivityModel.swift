...
public struct LocationActivity: Equatable, Codable {
  public var address: String?
  public var longitude: CLLocationDegrees?
  public var latitude: CLLocationDegrees?

  public init(address: String? = nil, longitude: CLLocationDegrees? = nil, latitude: CLLocationDegrees? = nil) {
...
public struct ActivityModel: Equatable, Codable, Hashable {
  ...
  public var location: LocationActivity?

  public init(name: String, city: String, image: String, price: Double,
  ...
  enum CodingKeys: String, CodingKey {
    case id = "_id"
    case name, image, city, price, status, location
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine(id ?? "" + name + city)
  }

  // swiftlint:disable function_body_length
  public static func sampleValues() -> [ActivityModel] {
      [
