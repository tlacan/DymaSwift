...
public final class NetworkClient {
  ...
  public init(server: Server, endpointMapperClass: EndpointMapper.Type = TripManagerEndpointMapper.self) {
    self.endpointMapperClass = endpointMapperClass
    self.server = server
  }

  public static func encodedDict(_ value: Encodable) -> [String: Any?]? {
  ...
  public func call<T: Decodable>(endPoint: APIEndPoint,
                                 dict: [String: Any?]? = nil,
  ...
  public func call<T: Decodable>(request: URLRequest) async -> APIResponse<T> {
    do {
  ...
  @discardableResult
  public func call<T>(endPoint: APIEndPoint,
                      onDone: @escaping @Sendable (APIResponse<T>) -> Void,
                      dict: [String: Any?]? = nil,
                      urlDict: [String: Any?]? = nil,
                      additionalHeaders: [String: String]? = nil,
  ...
  @discardableResult
  public func call<T: Decodable>(request: URLRequest,
                                 onDone: @escaping @Sendable (APIResponse<T>) -> Void) -> URLSessionDataTask {
  ...
  public static func randomAwait() async {
